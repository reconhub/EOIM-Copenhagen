...
**Authors:**
Jurgita Pakalniskiene, Gerhard Falkenhorst, Esther Kissling, Gilles Desv{\'e}

**Reviewers:**
Marta Valenciano, Alain Moren.

**Adaptions for previous modules:**
Irina Czogiel, Kristin Tolksdorf, Michaela Diercke, Sybille Somogyi, Christian Winter, Sandra Dudareva-Vizule with the help of Katharina Alpers, Alicia Barrasa, Androulla Efstratiou, Steen Ethelberg, Annette Hei{\ss}enhuber, Aftab Jasir, Ioannis Karagiannis and Pawel Stefanoff
...
Just as in STATA you can set a folder to be your working directory (using the setwd command).  
...
setwd("C:/Users/Desktop/MSF Training/Copenhagen/")
...
required_packages <- c("readxl", "foreign", "ggplot2", "Hmisc", "epiDisplay", "epiR") 
